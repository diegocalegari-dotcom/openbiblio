...
<form name="abntForm" method="POST" action="../reports/run_report.php" target="_blank">
  <input type="hidden" name="type" value="abnt_citation">
  <input type="hidden" name="bibids" value="<?php echo implode(',', array_map(function($b) { return $b->getBibid(); }, $biblioQ->getResults())); ?>">
  <input type="hidden" name="rpt_name" value="ABNT Report">
  <input type="submit" value="Gerar Citação ABNT" class="button">
</form>
