...
class BiblioQuery extends Query
{
    ...
    function updateMarcField($bibid, $tag, $subfield, $data) {
        $sql = $this->mkSQL("update biblio_field set field_data=%Q "
                         . "where bibid=%N and tag=%Q and subfield_cd=%Q",
                         $data, $bibid, $tag, $subfield);
        return $this->_query($sql, "Error updating MARC field.");
    }
