...
<br>
<form name="abntForm" method="POST" action="../reports/abnt_report.php" target="_blank">
  <input type="hidden" name="bibids" value="<?php echo implode(',', $bibids); ?>">
  <input type="submit" value="Gerar Relatório ABNT" class="button">
</form>
<br>
