...
<table class="primary">
    ...
    <?php
		...
		<td valign="top" class="<?php echo H($row_class); ?>">
                    <?php
                      $status_code = $copy->getStatusCd();
                      if (isset($biblioStatusDm[$status_code])) {
                        echo H($biblioStatusDm[$status_code]);
                      } else {
                        echo H($status_code); // Fallback to showing the code itself
                      }
                    ?>
                </td>
		<td valign="top" class="<?php echo H($row_class); ?>">
