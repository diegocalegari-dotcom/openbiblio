...
<?php if ($nav == "cobranca_atrasos") { ?>
 &raquo; <?php echo $navloc->getText("Cobrança de Atrasos"); ?><br>
<?php } else { ?>
 <a href="../circ/cobranca_atrasos.php" class="alt1"><?php echo $navloc->getText("Cobrança de Atrasos"); ?></a><br>
<?php } ?>
